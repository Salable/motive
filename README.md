...
onboarding tour of Motive's features. A paw in the menu bar has Settings, tour replay,
...
The [docs index](docs/README.md) has reading paths by audience; the individual guides:

- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — layering, design principles, and the component reference
- [docs/EMBEDDING.md](docs/EMBEDDING.md) — building your own pet on the Motive packages
...
- [docs/RELEASING.md](docs/RELEASING.md) — cutting releases and packaging the demo app
